        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <InputField label="Data Fee (per account)" id="dataFeePerAccount" value={inputs.dataFeePerAccount} onChange={(v) => updateInput('dataFeePerAccount', v)} min={0} step={0.001} unit="$" placeholder="Defaults to 2.073" tooltip="Fixed data cost per account" disabled={isDisabled} />
              ...
              <InputField label="Staffing Fee" id="staffingFeePercent" value={inputs.staffingFeePercent} onChange={(v) => updateInput('staffingFeePercent', v)} min={0} max={100} step={0.01} unit="%" placeholder="Defaults to 3.5%" tooltip="Percentage of gross revenue (eval + activation) for staffing" disabled={isDisabled} />
              ...
              <InputField label="Affiliate Fee" id="affiliateFeePercent" value={inputs.affiliateFeePercent} onChange={(v) => updateInput('affiliateFeePercent', v)} min={0} max={100} step={0.01} unit="%" placeholder="Defaults to 7.5%" tooltip="Percentage applied to eval revenue (and optionally activation) for affiliates" disabled={isDisabled} />
              <InputField label="Live Allocation" id="liveAllocationPercent" value={inputs.liveAllocationPercent} onChange={(v) => updateInput('liveAllocationPercent', v)} min={0} max={100} step={0.01} unit="%" placeholder="Defaults to 4%" tooltip="Percentage of gross revenue reserved for live allocation" disabled={isDisabled} />
              <InputField label="Live Allocation" id="liveAllocationPercent" value={inputs.liveAllocationPercent} onChange={(v) => updateInput('liveAllocationPercent', v)} min={0} max={100} step={0.01} unit="%" placeholder="Defaults to 4%" tooltip="Percentage of gross revenue reserved for live allocation" disabled={isDisabled} />
